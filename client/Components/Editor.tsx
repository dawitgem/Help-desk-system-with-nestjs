...
// }
// export const ReplyEditor = ({ module, setValue, value }: ReplyEditorProps) => {
//   const { Loading } = useSelector(selectTicket);
//   const ReactQuill = useMemo(
//     () => dynamic(() => import("react-quill"), { ssr: false }),
//     []
...
//   const onChange = (html: string) => {
//     setValue((prevState: any) => DOMPurify.sanitize(html));
//   };
...
//   const element = document.getElementById("ForwardEditor");
//   console.log(element);
//   if (element && element instanceof HTMLElement) {
